...
const SEEN_KEY = 'viva-ton:install-nudge' // device-local UI latch — deliberately NOT part of the synced save
const MAX_SHOWS = 3
...
function mount(scene: Phaser.Scene): void {
  ...
  body.textContent = 'Sign in or back it up so it follows you when you add Viva Ton to your home screen.'
