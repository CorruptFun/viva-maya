...
begin
    ...
    win as (
        select device_id, user_id, session_id, name, props, app_version, created_at,
               ...
               -- session TZ happens to be: the game's own day boundary (the
               -- endless race, core/endless.ts dayKey) is 00:00 UTC, and the
               -- dashboard must cut its days on the same line or "yesterday"
